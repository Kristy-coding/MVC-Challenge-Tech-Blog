...
// so if the user does not exists, meaning that they have not signed up/ loggedin then they can not interact with the database ... if they don't sign up then they will not have a user_id
